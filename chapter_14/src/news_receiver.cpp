...
int main(int argc, char* argv[])
{
	...
	inet_pton(AF_INET, "0.0.0.0", &join_addr.imr_interface.s_addr);

	int ret = setsockopt(server_sock, IPPROTO_IP, IP_ADD_MEMBERSHIP, (char*)&join_addr, static_cast<int>(sizeof(join_addr)));
	if (ret == sock_error)
	{
